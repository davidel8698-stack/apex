...
3. **Phase-7 R-item 3 — `test-subagent-cache.sh` + fresh-session documentation** (closes L-DH-03 methodology confound). **CLOSED 2026-05-26 (R-DH-P7-03):** test added at `framework/tests/test-subagent-cache.sh` — parses `sync-to-claude.sh` delivery declarations (mirrors R10-001 strategy), iterates all `framework/agents/**/*.md` + `framework/modules/apex-*/agent.md`, asserts both byte-equality AND mtime sanity (`src NOT newer than dst`) per file. 26/26 PASS after syncing 4 pre-existing drifted files (architect.md, auditor.md, wave-executor.md, frontend.md). SECURITY-RUNTIME.md appended with §"Subagent cache invalidation" documenting the fresh-session requirement. Design: `audit-trail-review/PHASE-7-RITEM-R-DH-P7-03-DESIGN-R2.md`; critic R2 PASS: `audit-trail-review/PHASE-7-RITEM-R-DH-P7-03-CRITIC-R2.md`.
